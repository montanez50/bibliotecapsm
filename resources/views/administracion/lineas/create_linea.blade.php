    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container-fluid" style="margin: 50px 0">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección para registrar una nueva Línea de Investigación, introduzca 
                    el nombre de la línea y su carrera asociada en el siguiente formulario
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Nueva Línea de Investigación</li>
                    </ol>
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="container-flat-form">
                ...
                <form autocomplete="off" method="POST" action="{{route('linea.store')}}">
                    @csrf
                            ...
                            <div class="group-material">
                                ...
                                <div class="group-material">
                                  ...
                                  <select
                                    ...
                                    data-toggle="tooltip"
                                    data-placement="top"
                                    title="Seleccione la carrera que corresponde la línea"
                                  >
