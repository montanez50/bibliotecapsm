    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container-fluid" style="margin: 50px 0">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección para modificar una editorial, introduzca el nombre 
                    de la editorial que modificará en el siguiente formulario
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Modificación de editorial</li>
                    </ol>
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="container-flat-form">
                ...
                <form autocomplete="off" method="POST" action="{{route('editorial.update', ['editorial' => $editorial])}}">
                    @method('PUT')
                    @csrf
