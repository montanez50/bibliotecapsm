        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">
                Biblioteca Digital "Santiago Mariño" <small>Añadir Video</small>
              </h1>
            </div>
          </div>
          ...
          <div class="container-fluid" style="margin: 50px 0">
            <div class="row">
              <div class="col-xs-12 col-sm-4 col-md-3">
                <img
                  src="{{asset('assets/img/flat-video.png')}}"
                  alt="video"
              ...
              <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                Bienvenido a la sección para agregar nuevos Videos a la biblioteca,
                deberas de llenar todos los campos para poder registrar el recurso
              </div>
            </div>
          </div>
          <div class="container-fluid">
            <form action="{{route('video.store')}}" method="POST" autocomplete="off" enctype="multipart/form-data">
              @csrf
              <div class="container-flat-form">
                <div class="title-flat-form title-flat-blue">Nuevo Video</div>
                <div class="row">
