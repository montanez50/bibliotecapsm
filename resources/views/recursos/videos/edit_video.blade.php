        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">
                Biblioteca Digital "Santiago Mariño"  <small>Editar Video</small>
              </h1>
            </div>
          </div>
          <div class="container-fluid" style="margin: 50px 0">
            <div class="row">
              ...
              <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                Bienvenido a la sección para editar Videos en la biblioteca,
                modifique todos los campos que desee para poder modificar el registro
              </div>
            </div>
          </div>
          <div class="container-fluid">
            <form action="{{route('video.update', ['video' => $video])}}" method="POST" autocomplete="off" enctype="multipart/form-data">
              @csrf
              @method('PUT')
              <div class="container-flat-form">
                <div class="title-flat-form title-flat-blue">Editar Video</div>
                <div class="row">
                  ...
                  <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                    <div class="group-material">
                        <input
                          ...
                          value="{{$video->publicaciones->titulo}}"
                        />
                      ...
                      <div class="group-material">
                        ...
                        <select
                          ...
                          data-placement="top" 
                          name="autor_id[]"
                          title="Elige el autor del video"
                          
                        >
                        @foreach($autores as $autor)
                        <option
                        value="{{ $autor->id }}"
                        @if(in_array($autor->id, $video->publicaciones->autores()->pluck('id')->toArray())) selected @endif
                        >
                            {{ $autor->nombre }}
                        </option>
                        @endforeach
                      ...
                      <div class="group-material">
                        ...
                        >
                          ...
                          <option value="{{ $carrera->id }}"
                            @if($carrera->id == $video->publicaciones->carrera_id) 
                              selected 
                            @endif
                            >
                      ...
                      <div class="group-material">
                        ...
                        <select
                          ...
                          data-toggle="tooltip"
                          data-placement="top"
                          title="Seleccione la asignatura a la que corresponde el video"
                        >
                          <option value="" disabled="" selected="">
                          ...
                          <option value="{{ $asignatura->id }}"
                            @if($asignatura->id == $video->asignatura_id) 
                              selected 
                            @endif
                            >
                  ...
                  <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                    <div class="group-material">
                      <input
                        ...
                        name="anio"
                        placeholder="Escribe aquí el año del video"
                        required=""
                        pattern="[0-9]{1,4}"
                        maxlength="4"
                        data-toggle="tooltip"
                        ...
                        value="{{$video->publicaciones->anio}}"
                      />
                      <span class="highlight"></span>
                      <span class="bar"></span>
                      <label>Año</label>
                    ...
                    <div class="group-material">
                      ...
                      <div class="group-material">
                        <input class="tooltips-general material-control" 
                            ...
                            name="archivo" 
                            id=""
                            title="Seleccione el archivo que contiene el video"
                        >
                        <span class="highlight"></span>
                        <span class="bar"></span>
