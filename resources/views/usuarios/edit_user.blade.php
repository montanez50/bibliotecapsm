    ...
    {{-- <x-nav-tabs :activeTab='$activeTab'/> --}}
        <div class="container-fluid" style="margin: 50px 0">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección para modificar
                    usuarios en el sistema, rellenar los
                    campos del siguiente formulario para actualizar el registro
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="container-flat-form">
                ...
                <form action="{{route('user.update', ['usuario' => $usuario])}}" method="POST" autocomplete="off">
                    @csrf
                    @method('PUT')
                    <div class="row">
